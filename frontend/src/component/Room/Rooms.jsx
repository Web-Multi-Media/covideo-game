    ...
    <Table className={classes.table} size="small">
      <TableHead>
        <TableRow>
          ...
          <TableCell align="left"><b>Last Activity</b></TableCell>
          <TableCell align="left"><b>Score</b></TableCell>
          <TableCell align="left"><b>Players</b></TableCell>
        </TableRow>
      </TableHead>
      <TableBody>
        {
          rooms.map((room) => (<TableRow key={room.id}>
            <TableCell component="th" scope="row"><b>{room.id}</b></TableCell>
            ...
            <TableCell align="left"><Button id="outlined-basic-name" className="margButt" variant="contained" color="primary" onClick={joinRoom.bind(this, room.id)}>Join</Button></TableCell>
          </TableRow>))
        }
      </TableBody>
    </Table>
